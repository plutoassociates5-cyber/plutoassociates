  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-5 pl-6 border-l-4 border-wp-blue shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          <small className="text-[0.68rem] text-text-light uppercase tracking-[1px] font-semibold block mb-1">Total Articles</small>
          <div className="text-3xl lg:text-4xl font-bold text-[#1d2327] leading-none">{counts.total}</div>
        </div>
        <div className="bg-white p-5 pl-6 border-l-4 border-l-accent-green shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          <small className="text-[0.68rem] text-text-light uppercase tracking-[1px] font-semibold block mb-1">Published</small>
          <div className="text-3xl lg:text-4xl font-bold text-[#1d2327] leading-none">{counts.published}</div>
        </div>
        <div className="bg-white p-5 pl-6 border-l-4 border-l-accent-orange shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          <small className="text-[0.68rem] text-text-light uppercase tracking-[1px] font-semibold block mb-1">Drafts</small>
          <div className="text-3xl lg:text-4xl font-bold text-[#1d2327] leading-none">{counts.drafts}</div>
        </div>
        <div className="bg-white p-5 pl-6 border-l-4 border-l-accent-purple shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          <small className="text-[0.68rem] text-text-light uppercase tracking-[1px] font-semibold block mb-1">Categories</small>
          <div className="text-3xl lg:text-4xl font-bold text-[#1d2327] leading-none">{counts.categories}</div>
        </div>
      </div>
