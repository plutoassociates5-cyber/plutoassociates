    ...
    <>
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 lg:h-24">
            <Link to="/" className="flex items-center no-underline gap-3.5">
              <img src={logoSrc} alt="Pluto Associates — Advocates and Legal Consultants" title="Pluto Associates" className="h-12 w-auto object-contain shrink-0" />
      ...
      <div className={`fixed top-0 -right-full w-[85%] max-w-[360px] h-screen bg-navy z-[10001] transition-all duration-500 flex flex-col${mobileOpen ? ' right-0' : ''}`} id="mobile-menu" aria-label="Mobile navigation">
        ...
        <div className="flex items-center gap-3 p-6 border-b border-white/5">
          <img src={logoSrc} alt="Pluto Associates" title="Pluto Associates" className="h-11 w-auto object-contain shrink-0" />
